...
export declare function rowsHeight(config: IGridConfig, rows: IRow[], from: number, to: number): number;
export declare function colsWidth(config: IGridConfig, cols: ICol[], from: number, to: number): number;
