...
async function initPg() {
	...
	const factTypes = [
		...
		{
			entityTypeId: human,
			code: 'AssistedConception',
			name: 'Assisted Conception',
			relationshipScope: 'parent',
			description: "A fact of a person's asisted conception such as IVF, ICSI, donor sperm, donor egg, surrogate, etc.",
			required: 'date',
			createdBy: clubside,
			modifiedBy: clubside
		},
